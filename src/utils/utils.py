...
def validate_integer(value: any, column_name: str) -> Optional[int]:
    ...
    try:
        ...
        logger.warning(f"Invalid integer value '{value}' for column '{column_name}', converting to None")
        return None
...
def validate_numeric(value: any, column_name: str, precision: int, scale: int) -> Optional[float]:
    ...
    try:
        ...
        logger.warning(f"Invalid numeric value '{value}' for column '{column_name}', converting to None")
        return None
